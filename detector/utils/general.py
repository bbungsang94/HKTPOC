...
from detector.utils.downloads import gsutil_getsize
from detector.utils.metrics import box_iou, fitness
...
def scale_coords(img1_shape, coords, img0_shape, ratio_pad=None):
    ...
    coords[:, [0, 2]] /= gain[0]  # x padding
    coords[:, [1, 3]] /= gain[1]  # y padding
